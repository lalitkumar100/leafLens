...
const PlantReport = ({ reportData, image, onNewScan, language = "en" }) => {
  ...
  const handleDownload = () => {
    // 🔹 In a real app, send language to backend to generate localized PDF
    console.log(`Generating PDF in language: ${language}`);
    alert(`Downloading PDF in ${REPORT_TRANSLATIONS[language]?.commonName ? language : 'English'}... (Backend integration required)`);
  };
